...
if __name__ == '__main__':
    ...
    data_path = 'datasets/new_samples/full/train_new_samples.json'
    Qid2answers = main(data_path)
    dump('datasets/new_samples/full/{}_hop.json'.format(mode), Qid2answers)